...
class ReportTrafficJamScreen extends StatefulWidget {
  const ReportTrafficJamScreen({super.key});

  @override
  State<ReportTrafficJamScreen> createState() => _ReportTrafficJamScreenState();
}

class _ReportTrafficJamScreenState extends State<ReportTrafficJamScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text("Report Traffic Jam", style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold)),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: "Add more information about the traffic...",
                  ...
                  child: _image == null 
                    ? const Column(
                        ...
                        children: [
                          ...
                          Text("Capture the traffic situation", style: TextStyle(color: Colors.white24, fontSize: 12)),
                        ]
                      )
                    : ClipRRect(
